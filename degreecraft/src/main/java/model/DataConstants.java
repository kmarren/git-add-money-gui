...
public abstract class DataConstants {
    ...
    protected static final String MAJOR_FILE_NAME = "degreecraft/src/main/java/data/majors.json";
    ...
    protected static final String COURSE_FILE_NAME = "degreecraft/src/main/java/data/courses.json";
    ...
    protected static final String USER_FILE_NAME = "degreecraft/src/main/java/data/users.json";
    ...
    protected static final String FACULTY_FILE_NAME = "degreecraft/src/main/java/data/faculty.json";
    ...
    protected static final String ADVISORS_FILE_NAME = "degreecraft/src/main/java/data/advisors.json";
    ...
    protected static final String STUDENT_FILE_NAME = "degreecraft/src/main/java/data/students.json";
    ...
    protected static final String ACHIEVEMENT_FILE_NAME = "degreecraft/src/main/java/data/achievements.json";
    ...
    protected static final String APPOINTMENT_FILE_NAME = "degreecraft/src/main/java/data/appointments.json";
